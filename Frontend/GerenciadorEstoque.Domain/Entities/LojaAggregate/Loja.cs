using GerenciadorEstoque.Domain.Entities.Core;
using GerenciadorEstoque.Domain.Entities.LojaAggregate.Validations;
using System;
...
namespace GerenciadorEstoque.Domain.Entities.LojaAggregate;
